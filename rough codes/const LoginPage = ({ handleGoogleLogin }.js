            ...
            <form action="#" className="mx-auto max-w-[24rem] text-left">
                ...
                <div className="">
                    ...
                    <Input placeholder="Password" type={passwordShown ? "text" : "password" }
                        ...
                        className="border! border-gray-300! bg-white text-gray-900 ring-4 ring-transparent placeholder:text-gray-500 placeholder:opacity-100 focus:border-gray-900! focus:border-t-gray-900! "
                        labelProps={{ className: "hidden" , }} containerProps={{ className: "min-w-[100px]" , }} icon={
                ...
                {/* Google login button */}
                <Button variant="outlined" size="lg" className="mt-6 flex h-12 items-center justify-center gap-2"
