...
const customTheme: CustomFlowbiteTheme = {
	...
	badge: {
		root: {
			base: "w-fit h-fit inline-flex font-bold",
			color: {
				info: "bg-yellow-500 text-blue-800 group-hover:bg-yellow-500 dark:bg-cyan-200 dark:text-red-800 dark:group-hover:bg-cyan-300",
